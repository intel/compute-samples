...
test_asm_sgemm(const global float *A, const global float *B, global float *C,
  ...
  __asm__ volatile(
      ...
      ".decl tmp2 v_type=G type=q num_elts=1 align=qword\n"
      ".decl N_00 v_type=G type=ud num_elts=1 align=dword alias=<%[N], 0>\n"
      "    mov (M1_NM, 1) tmp2(0,0)<1> N_00(0,0)<0;1,0>\n"

      ".decl P1 v_type=P num_elts=16\n"
      "    cmp.eq (M1_NM, 16) P1 %[N](0,0)<0;1,0> 0x0:d\n"
      "    (!P1) goto (M1, 1) my_label0\n"
      ...
      ".decl n_2 v_type=G type=uq num_elts=1 align=qword alias=<n, 0>\n"
      ".decl tmp2_0 v_type=G type=uq num_elts=1 align=qword alias=<tmp2, 0>\n"
      "    cmp.lt (M1_NM, 8) P2 n_2(0,0)<0;1,0> tmp2_0(0,0)<0;1,0>\n"
      "    cmp.lt (M3_NM, 8) P2 n_2(0,0)<0;1,0> tmp2_0(0,0)<0;1,0>\n"
      "    (P2) goto (M1, 1) my_label3\n"
      ...
      "    mad (M1, 16) beta_C(0,0)<1> %[alpha](0,0)<0;1,0> acc(0,0)<1;1,0> "
      "beta_C(0,0)<1;1,0>\n"
