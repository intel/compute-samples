...
test_whole_kernel(const global uint *pSrc, global uint *pDst) {
  ...
  __asm__ volatile(
      ...
      "    and (M1, 16) and85(0,0)<1> VV0048(4,0)<1;1,0> 0xff:d\n"
      ...
      "    and (M1, 16) and91(0,0)<1> VV0052(4,0)<1;1,0> 0xff:d\n"
      ...
      "    and (M1, 16) and97(0,0)<1> VV0056(4,0)<1;1,0> 0xff:d\n"
      ...
      "    and (M1, 16) and85_1(0,0)<1> VV0048(4,0)<1;1,0> 0xff00:d\n"
      ...
      "    and (M1, 16) and91_1(0,0)<1> VV0052(4,0)<1;1,0> 0xff00:d\n"
      ...
      "    and (M1, 16) and97_1(0,0)<1> VV0056(4,0)<1;1,0> 0xff00:d\n"
      ...
      "    and (M1, 16) and85_2(0,0)<1> VV0048(4,0)<1;1,0> 0xff0000:d\n"
      ...
      "    and (M1, 16) and91_2(0,0)<1> VV0052(4,0)<1;1,0> 0xff0000:d\n"
      ...
      "    and (M1, 16) and97_2(0,0)<1> VV0056(4,0)<1;1,0> 0xff0000:d\n"
      ...
      "    and (M1, 16) and85_3(0,0)<1> VV0048(4,0)<1;1,0> 0xff000000:d\n"
      ...
      "    and (M1, 16) and91_3(0,0)<1> VV0052(4,0)<1;1,0> 0xff000000:d\n"
      ...
      "    and (M1, 16) and97_3(0,0)<1> VV0056(4,0)<1;1,0> 0xff000000:d\n"
