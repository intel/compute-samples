...
test_asm_stencil_5_point(const int size, global const float *input,
  ...
  __asm__ volatile(
      ...
      "    cmp.lt (M1, 16) my_P1 %[i](0,0)<1;1,0> size_minus_5(0,0)<0;1,0>\n"
      ".decl my_P2 v_type=P num_elts=16\n"
      "    cmp.gt (M1, 16) my_P2 %[i](0,0)<1;1,0> 0x4:d\n"
      "    and (M1, 16) my_P2 my_P2 my_P1\n"
      ".decl my_P3 v_type=P num_elts=16\n"
      "    cmp.gt (M1, 16) my_P3 %[j](0,0)<1;1,0> 0x4:d\n"
      "    and (M1, 16) my_P3 my_P3 my_P2\n"
      ".decl my_P4 v_type=P num_elts=16\n"
      "    cmp.lt (M1, 16) my_P4 %[j](0,0)<1;1,0> size_minus_5(0,0)<0;1,0>\n"
      "    and (M1, 16) my_P4 my_P4 my_P3\n"
      "    (!my_P4) goto (M1, 16) my_label0\n"
