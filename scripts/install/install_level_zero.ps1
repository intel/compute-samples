...
wget -Uri https://github.com/oneapi-src/level-zero/archive/v1.10.0.zip -OutFile level-zero-1.10.0.zip

echo "Extracting Level Zero"
. "C:\Program Files\7-Zip\7z.exe" x level-zero-1.10.0.zip
...
rm -R level-zero-1.10.0
rm level-zero-1.10.0.zip
